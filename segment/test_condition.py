...
def get_opt():
    ...
    parser.add_argument('--tocg_checkpoint', type=str, default=r'.\segment\checkpoint\train\tocg_final.pth', help='tocg checkpoint')
    parser.add_argument('--D_checkpoint', type=str, default=r'.\segment\checkpoint\train\D_final.pth', help='D checkpoint')
...
def test(opt, test_loader, board, tocg, D=None):
    ...
    for inputs in test_loader.data_loader:
        ...
        for i in range(c_paired.shape[0]):
            ...
            path = os.path.join("../dataset" + '/pre_segment',(iname[0].replace("jpg", "png")))

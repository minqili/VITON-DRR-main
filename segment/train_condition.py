...
def get_opt():
    ...
    parser.add_argument("--dataroot", default="./VITON_data/")
    ...
    parser.add_argument("--keep_step", type=int, default=600000)
    ...
    parser.add_argument("--test_dataroot", default="./VITON_data/")
    parser.add_argument("--test_data_list", default="train_pairs.txt")
...
def train(opt, train_loader, test_loader, val_loader, board, tocg, D):
    ...
    for step in tqdm(range(opt.load_step, opt.keep_step)):
        ...
        cm_paired = inputs['cloth_mask']['unpaired'].cuda()

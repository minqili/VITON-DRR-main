...
class AlignedDataset(BaseDataset):
    def initialize(self, opt):
        ...
        # # input seg-pre
        # dir_pre = '_A' if self.opt.label_nc == 0 else '_pre'
        # self.dir_pre = os.path.join(opt.dataroot, opt.phase + dir_pre)
        # self.pre_paths = sorted(make_dataset_test(self.dir_pre))
    ...
    def __getitem__(self, index):
        ...
        c_name = self.cloth_names[test]
        h_name = self.human_names[test]
        ...
        input_dict = {'label': A_tensor, 'image': B_tensor,
                      ...
                      'edge': E_tensor, 'color': C_tensor, 'mask': M_tensor, 'colormask': MC_tensor, 'pose': P_tensor, 'h_name': h_name
                      }
